...
type Message struct {
	...
	ToUser    sql.NullInt64  `db:"to_user" json:"to_user,omitempty"` // For direct messages
...
type Room struct {
	...
	CreatorID    sql.NullInt64  `db:"creator_id" json:"creator_id,omitempty"`
...
type RoomWithDetails struct {
	...
	MemberCount  int64          `db:"member_count" json:"member_count,omitempty"`
	OnlineCount  int64          `db:"online_count" json:"online_count,omitempty"`
	...
	UnreadCount  int64          `db:"unread_count" json:"unread_count,omitempty"`
...
type RoomMemberWithUser struct {
	...
	MessageCount int64          `db:"message_count" json:"message_count,omitempty"`
}
...
type RoomMessage struct {
	ID          int64         `db:"id" json:"id"`
	RoomID      int64         `db:"room_id" json:"room_id"`
	UserID      sql.NullInt64 `db:"user_id" json:"user_id,omitempty"` // Null for system messages
	Content     string        `db:"content" json:"content"`
